...
///
/// Muestra los términos legales y condiciones de uso de la aplicación.
class TermsPage extends StatelessWidget {
  const TermsPage({super.key});

  @override
  Widget build(BuildContext context) {
    const TextStyle sectionTitle =
        TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold);
    const TextStyle paragraph = TextStyle(fontSize: 16.0, height: 1.5);
