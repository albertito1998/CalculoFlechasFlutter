    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const InfoCard(
              title: 'Comprobar Flecha Real en 1 Vano',
              content:
                  'Determina si el cable está correctamente tensado comparando la flecha real medida con la teórica.',
